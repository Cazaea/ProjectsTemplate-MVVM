package com.hxd.root.http.interceptor.httpparams;
...
public class HttpFixedParams {
    ...
    public static void init(Context context) {
        HttpFixedParams.context = context;
        params = UserUtil.getUserInfo();
    }

    public static String getHeader(String httpMethod) {
        long currentTime = System.currentTimeMillis() / 1000;
        return getPlatform() + getVersion() + getUniqueId() + httpMethod + "0" + currentTime;
    }
